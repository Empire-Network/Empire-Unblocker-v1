...
function widget () {
    ...
    window.navigator.serviceWorker.register('/sw.js', {
        ...
        location.href=__uv$config.prefix + __uv$config.encodeUrl('https://e.widgetbot.io/channels/1154656520924037130/1136019584911155200');
    });
...
function insta () {
    ...
    window.navigator.serviceWorker.register('/sw.js', {
        ...
        location.href=__uv$config.prefix + __uv$config.encodeUrl('https://instagram.com');
    });
...
function brave () {
    ...
    window.navigator.serviceWorker.register('/sw.js', {
        ...
        location.href=__uv$config.prefix + __uv$config.encodeUrl('https://search.brave.com');
    });
